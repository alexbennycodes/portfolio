    ...
    <>
      <nav role="navigation" className="lg:hidden">
        <div className="flex flex-col z-10 select-none">
          ...
          <ul className="fixed top-0 right-0 md:w-[350px] w-[75%] h-screen shadow-sm shadow-white/40 p-[50px] bg-[#0be881] origin-center translate-x-[120vw] transform duration-500 peer-checked:translate-x-[7%] flex flex-col items-end pr-[40px] pt-[75px] z-20">
            {links.map((link, i) => (
              <li
